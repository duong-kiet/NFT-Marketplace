...
import { getTokenURI } from "../helpers/getTokenURI";
...
export default function Transfer({ event }: { event: any }) {
  ...
  useEffect(() => {
    ...
    async function fetchMeta() {
      try {
        const uri = await getTokenURI(event.tokenId);
                ...
                <Stack spacing={2} sx={{ ml: 4 }}>
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 600, marginLeft: 8 }}>
                      {shortenAddress(event.from) || "Unknown"}
                    </span>
                  </Typography>
                  <Typography
                    sx={{
